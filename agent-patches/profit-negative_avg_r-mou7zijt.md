# Agent Patch profit-negative_avg_r-mou7zijt

## Title
[ProfitEngine] Optimize exit strategy — negative avgR

## Summary
Average R across 30 trades is -0.075. Add exit quality diagnostics to performance scorecard and identify R-drag patterns.
...
## Commit Plan
- commitMessage: agent: [ProfitEngine] Optimize exit strategy — negative avgR [optimizationType:exit_optimization]
- targetBranch: main
- pushDirect: true

## Generated At
2026-05-06T19:36:45.621Z
