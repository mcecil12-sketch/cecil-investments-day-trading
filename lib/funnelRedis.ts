...
const NUMERIC_COUNTERS = [
  ...
  "drainClaimedThisRun",
  "drainSentToScorer",
  "drainPersistedScored",
  "drainPersistedArchived",
  "drainPersistedError",
  "drainPreGptSkipped",
  // Detailed skip reasons (existing)
  "drainSkippedInsufficientBars",
  "drainSkippedVolumeTooLow",
  "drainSkippedDollarVolume",
  "drainSkippedPriceTooLow",
  "drainSkippedSpreadTooWide",
  // New skip reasons (v2 optimization)
  ...
  "seedHighPriorityEnqueued",
  "seedHighPriorityDequeued",
  "seedStaleDropped",
  "seedRecoverySeeded",
  "seedRealTimeSeeded",
